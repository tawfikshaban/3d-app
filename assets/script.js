...
document.querySelector(".page-2 h2").textContent.split("").forEach((word) => {
    clutter += `<span>${word}</span>`
    document.querySelector(".page-2 h2").innerHTML = clutter
})

gsap.to(".page-2 h2 span", {
    scrollTrigger: {
...
document.querySelector(".page-4 h2").textContent.split("").forEach((word) => {

    clutter2 += `<span>${word}</span>`
    document.querySelector(".page-4 h2").innerHTML = clutter2
})

gsap.to(".page-4 h2 span", {
    scrollTrigger: {
        trigger: ".page-4 h2 span",
        start: "top bottom",
        end: "bottom top",
        scroller: 'main',
        scrub: .5,
...
document.querySelector(".page-6 h2").textContent.split("").forEach((word) => {

    clutter3 += `<span>${word}</span>`
    document.querySelector(".page-6 h2").innerHTML = clutter3
})

gsap.to(".page-6 h2 span", {
    scrollTrigger: {
        trigger: ".page-6 h2 span",
        start: "top bottom",
        end: "bottom top",
        scroller: 'main',
        scrub: .5,
